...
The Support group can be reached out to at [One Punch Support](https://t.me/noha_support), , discover/request new features, report bugs, and stay in the loop whenever a new update is available. 

News channel as at [One Punch Updates](https://t.me/Noha_Updates) 
...
```
  ...
  [![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/flashokiller/NohA.git)
